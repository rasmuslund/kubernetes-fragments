package dk.ralu.k8s.fragments.k8s.fragments.restapi;

import dk.ralu.k8s.fragments.k8s.fragments.jpa.Person;
import dk.ralu.k8s.fragments.k8s.fragments.jpa.PersonRepository;
